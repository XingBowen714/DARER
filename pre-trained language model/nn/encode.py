from transformers import BertConfig, BertModel, RobertaModel, XLNetModel, AlbertModel, ElectraModel,RobertaConfig, XLNetConfig
...
class UtterancePretrainedModel(nn.Module):
    ...
    def __init__(self, hidden_dim, pretrained_model):
        ...
        if pretrained_model == "bert":
            config = BertConfig.from_pretrained("/home/bxing/Data/supports/bert-base-uncased")
            self._encoder = BertModel.from_pretrained(
            "/home/bxing/Data/supports/bert-base-uncased", config=config, from_tf =False)
        elif pretrained_model == "roberta":
            config = RobertaConfig.from_pretrained("/home/bxing/Data/supports/roberta-base")
            self._encoder = RobertaModel.from_pretrained(
            "/home/bxing/Data/supports/roberta-base", config=config, from_tf =False)
            #self._encoder = RobertaModel.from_pretrained("roberta-base")
        elif pretrained_model == "xlnet":
            config = XLNetConfig.from_pretrained("/home/bxing/Data/supports/xlnet-base-cased")
            self._encoder = XLNetModel.from_pretrained("/home/bxing/Data/supports/xlnet-base-cased", config=config, from_tf=False)
