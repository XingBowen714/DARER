...
parser.add_argument("--random_wordvec", "-rw", type=bool, default=False)
...
parser.add_argument("--margin_coefficient", "-mc", type=int, default=1,
                    help="stacking number for DTRR")
...
for epoch in range(0, args.num_epoch + 1):
    ...
    #if epoch < 15:
     #   bert_lr = args.bert_learning_rate * 10
    #else:
